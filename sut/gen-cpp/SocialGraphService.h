...
class SocialGraphServiceIf {
 public:
  ...
  virtual void GetFollowers(std::vector<int64_t> & _return, const int64_t req_id, const int64_t user_id, const std::map<std::string, std::string, std::less<>> & carrier) = 0;
  virtual void GetFollowees(std::vector<int64_t> & _return, const int64_t req_id, const int64_t user_id, const std::map<std::string, std::string, std::less<>> & carrier) = 0;
  virtual void Follow(const int64_t req_id, const int64_t user_id, const int64_t followee_id, const std::map<std::string, std::string, std::less<>> & carrier) = 0;
  virtual void Unfollow(const int64_t req_id, const int64_t user_id, const int64_t followee_id, const std::map<std::string, std::string, std::less<>> & carrier) = 0;
  virtual void FollowWithUsername(const int64_t req_id, const std::string& user_usernmae, const std::string& followee_username, const std::map<std::string, std::string, std::less<>> & carrier) = 0;
  virtual void UnfollowWithUsername(const int64_t req_id, const std::string& user_usernmae, const std::string& followee_username, const std::map<std::string, std::string, std::less<>> & carrier) = 0;
  virtual void InsertUser(const int64_t req_id, const int64_t user_id, const std::map<std::string, std::string, std::less<>> & carrier) = 0;
};
...
class SocialGraphServiceNull : virtual public SocialGraphServiceIf {
 public:
  ...
  void GetFollowers(std::vector<int64_t> & /* _return */, const int64_t /* req_id */, const int64_t /* user_id */, const std::map<std::string, std::string, std::less<>> & /* carrier */) {
    return;
  }
  void GetFollowees(std::vector<int64_t> & /* _return */, const int64_t /* req_id */, const int64_t /* user_id */, const std::map<std::string, std::string, std::less<>> & /* carrier */) {
    return;
  }
  void Follow(const int64_t /* req_id */, const int64_t /* user_id */, const int64_t /* followee_id */, const std::map<std::string, std::string, std::less<>> & /* carrier */) {
    return;
  }
  void Unfollow(const int64_t /* req_id */, const int64_t /* user_id */, const int64_t /* followee_id */, const std::map<std::string, std::string, std::less<>> & /* carrier */) {
    return;
  }
  void FollowWithUsername(const int64_t /* req_id */, const std::string& /* user_usernmae */, const std::string& /* followee_username */, const std::map<std::string, std::string, std::less<>> & /* carrier */) {
    return;
  }
  void UnfollowWithUsername(const int64_t /* req_id */, const std::string& /* user_usernmae */, const std::string& /* followee_username */, const std::map<std::string, std::string, std::less<>> & /* carrier */) {
    return;
  }
  void InsertUser(const int64_t /* req_id */, const int64_t /* user_id */, const std::map<std::string, std::string, std::less<>> & /* carrier */) {
    return;
  }
};
...
class SocialGraphServiceClient : virtual public SocialGraphServiceIf {
 ...
 public:
  ...
  void GetFollowers(std::vector<int64_t> & _return, const int64_t req_id, const int64_t user_id, const std::map<std::string, std::string, std::less<>> & carrier);
  void send_GetFollowers(const int64_t req_id, const int64_t user_id, const std::map<std::string, std::string, std::less<>> & carrier);
  void recv_GetFollowers(std::vector<int64_t> & _return);
  void GetFollowees(std::vector<int64_t> & _return, const int64_t req_id, const int64_t user_id, const std::map<std::string, std::string, std::less<>> & carrier);
  void send_GetFollowees(const int64_t req_id, const int64_t user_id, const std::map<std::string, std::string, std::less<>> & carrier);
  void recv_GetFollowees(std::vector<int64_t> & _return);
  void Follow(const int64_t req_id, const int64_t user_id, const int64_t followee_id, const std::map<std::string, std::string, std::less<>> & carrier);
  void send_Follow(const int64_t req_id, const int64_t user_id, const int64_t followee_id, const std::map<std::string, std::string, std::less<>> & carrier);
  void recv_Follow();
  void Unfollow(const int64_t req_id, const int64_t user_id, const int64_t followee_id, const std::map<std::string, std::string, std::less<>> & carrier);
  void send_Unfollow(const int64_t req_id, const int64_t user_id, const int64_t followee_id, const std::map<std::string, std::string, std::less<>> & carrier);
  void recv_Unfollow();
  void FollowWithUsername(const int64_t req_id, const std::string& user_usernmae, const std::string& followee_username, const std::map<std::string, std::string, std::less<>> & carrier);
  void send_FollowWithUsername(const int64_t req_id, const std::string& user_usernmae, const std::string& followee_username, const std::map<std::string, std::string, std::less<>> & carrier);
  void recv_FollowWithUsername();
  void UnfollowWithUsername(const int64_t req_id, const std::string& user_usernmae, const std::string& followee_username, const std::map<std::string, std::string, std::less<>> & carrier);
  void send_UnfollowWithUsername(const int64_t req_id, const std::string& user_usernmae, const std::string& followee_username, const std::map<std::string, std::string, std::less<>> & carrier);
  void recv_UnfollowWithUsername();
  void InsertUser(const int64_t req_id, const int64_t user_id, const std::map<std::string, std::string, std::less<>> & carrier);
  void send_InsertUser(const int64_t req_id, const int64_t user_id, const std::map<std::string, std::string, std::less<>> & carrier);
...
class SocialGraphServiceConcurrentClient : virtual public SocialGraphServiceIf {
 ...
 public:
  ...
  void GetFollowers(std::vector<int64_t> & _return, const int64_t req_id, const int64_t user_id, const std::map<std::string, std::string, std::less<>> & carrier);
  int32_t send_GetFollowers(const int64_t req_id, const int64_t user_id, const std::map<std::string, std::string, std::less<>> & carrier);
  void recv_GetFollowers(std::vector<int64_t> & _return, const int32_t seqid);
  void GetFollowees(std::vector<int64_t> & _return, const int64_t req_id, const int64_t user_id, const std::map<std::string, std::string, std::less<>> & carrier);
  int32_t send_GetFollowees(const int64_t req_id, const int64_t user_id, const std::map<std::string, std::string, std::less<>> & carrier);
  void recv_GetFollowees(std::vector<int64_t> & _return, const int32_t seqid);
  void Follow(const int64_t req_id, const int64_t user_id, const int64_t followee_id, const std::map<std::string, std::string, std::less<>> & carrier);
  int32_t send_Follow(const int64_t req_id, const int64_t user_id, const int64_t followee_id, const std::map<std::string, std::string, std::less<>> & carrier);
  void recv_Follow(const int32_t seqid);
  void Unfollow(const int64_t req_id, const int64_t user_id, const int64_t followee_id, const std::map<std::string, std::string, std::less<>> & carrier);
  int32_t send_Unfollow(const int64_t req_id, const int64_t user_id, const int64_t followee_id, const std::map<std::string, std::string, std::less<>> & carrier);
  void recv_Unfollow(const int32_t seqid);
  void FollowWithUsername(const int64_t req_id, const std::string& user_usernmae, const std::string& followee_username, const std::map<std::string, std::string, std::less<>> & carrier);
  int32_t send_FollowWithUsername(const int64_t req_id, const std::string& user_usernmae, const std::string& followee_username, const std::map<std::string, std::string, std::less<>> & carrier);
  void recv_FollowWithUsername(const int32_t seqid);
  void UnfollowWithUsername(const int64_t req_id, const std::string& user_usernmae, const std::string& followee_username, const std::map<std::string, std::string, std::less<>> & carrier);
  int32_t send_UnfollowWithUsername(const int64_t req_id, const std::string& user_usernmae, const std::string& followee_username, const std::map<std::string, std::string, std::less<>> & carrier);
  void recv_UnfollowWithUsername(const int32_t seqid);
  void InsertUser(const int64_t req_id, const int64_t user_id, const std::map<std::string, std::string, std::less<>> & carrier);
  int32_t send_InsertUser(const int64_t req_id, const int64_t user_id, const std::map<std::string, std::string, std::less<>> & carrier);
